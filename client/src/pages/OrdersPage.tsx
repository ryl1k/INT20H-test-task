...
function exportCsv(orders: Order[], addToast: (t: { type: "success" | "warning"; message: string }) => void, t: (key: string, opts?: Record<string, unknown>) => string) {
  ...
  const headers = "id,latitude,longitude,subtotal,tax_rate,tax_amount,total,county,timestamp\n";
  const rows = orders.map((o) =>
    [o.id, o.latitude, o.longitude, o.subtotal, o.composite_tax_rate, o.tax_amount, o.total_amount, o.jurisdictions.county, o.timestamp].join(",")
  ).join("\n");
...
export function OrdersPage() {
  ...
  const handleSort = (col: string, dir: "asc" | "desc") => {
    setFilters({ sortBy: col as keyof Order, sortDir: dir });
  };
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-end gap-3">
        ...
        <div className="ml-auto flex items-end gap-2">
          ...
          <Button variant="secondary" size="md" onClick={() => exportCsv(orders, addToast, t)}>
            {t("orders.export")}
          </Button>
        </div>
      </div>
